export function GoogleButton({ children, ...rest }) {
  return (
    <button
      type="button"
      {...rest}
      className="w-full inline-flex items-center justify-center gap-3 rounded-button border border-brand-200 bg-brand-50/60 hover:bg-brand-50 text-ink font-semibold py-3 text-base transition-colors"
    >
      <span>{children}</span>
