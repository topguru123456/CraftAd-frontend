...
/**
 * Pill-shaped gradient CTA with the nested plus badge used on the
 * projects/brands toolbars (white tile → light-pink tile → pink +).
 */
...
export function GradientCreateButton({
  ...
  return (
    <button
      type={type}
      className={cn(
        'inline-flex items-center gap-3 rounded-pill px-5 py-2.5',
